...
public abstract  class HqBaseException extends RuntimeException {
    ...
    public HqBaseException(String errCode, String errMsg){
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public HqBaseException(String errCode, String errMsg, Throwable causeBy) {
        this(errCode, errMsg);
